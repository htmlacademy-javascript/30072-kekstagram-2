...
import { CommentId, CommentAvatar, COMMENT_MESSAGE_MIN, COMMENT_NAME_MIN, PhotoId, PhotoNumber, PHOTO_DESCRIPTION_MIN, PhotoLike, PhotoComment, PHOTO_AMOUNT } from './constants.js';
...
Array.from({length: PHOTO_AMOUNT}, createPhotoData);
